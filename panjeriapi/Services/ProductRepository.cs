...
namespace panjeriapi.Services
{
    public class ProductRepository : IProductRepository
    {
        ...
        {
            new ProductDto { ProductId = 1, Amount = "300", Category = "1", Image = "", Price = "100", ProductName = "Product-1", Quantity = "3", WritterName = "Jamal" },
            new ProductDto { ProductId = 2, Amount = "500", Category = "2", Image = "", Price = "100", ProductName = "Product-12", Quantity = "3", WritterName = "Jamal" },
            new ProductDto { ProductId = 3, Amount = "3900", Category = "3", Image = "", Price = "100", ProductName = "Product-18", Quantity = "3", WritterName = "Jamal" },
